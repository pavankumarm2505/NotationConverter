...
class PublicGameState:
  ...
  def reverse(self):
    self.handsizes = self.handsizes[-2::-1] + [self.handsizes[-1]]
...
class Uno:
  ...
  def __init__(self, players):
    ...
    self.game_state = PublicGameState(discard, Color.NONE, [Uno.INITIAL_CARDS_PER_PLAYER for p in self.players])
...
if __name__ == '__main__':
  ...
  players = ['Group33Human', 'Group33AI'] # Replace names of players
  game = Uno(players)
  winner = game.play()
  print(f"{winner} wins!")
